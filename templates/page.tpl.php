    ...
    <?php if ($site_name || $site_slogan): ?>
      <hgroup id="name-and-slogan">
        <?php if ($site_name): ?>
          ...
          <div class='pause-button'><img src="../sites/all/themes/zen-barnettech/images/pause_button.png" alt=""></div>
          <div class='play-button'><img src="../sites/all/themes/zen-barnettech/images//play_button.png" alt=""></div>
